...
import 'package:sountrends/utils/const.dart';
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    Row(
                      ...
                      children: <Widget>[
                        IconButton(
                          icon: Icon(Icons.search, color: singleton.dark_theme ? Colors.black : Colors.white),
                          onPressed: () {
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton.icon(
                          ...
                          icon: Icon(Icons.calendar_today, color: singleton.dark_theme ? Colors.black : Colors.white),
                          label: Text(''),
                        ),
                      ],
                    ),
