...
import 'package:sountrends/views/top.dart';
...
class _registroState extends State<home> {
  ...
  void initState() {
    super.initState();
    _dataFuture =fetchdata( super.widget.token); 
                        ...
                        child: Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Text('Welcome,', style: TextStyle(color: singleton.dark_theme ? Colors.black : Colors.white, fontSize: 35, fontWeight: FontWeight.w900)),
                                  Text(
                                    maxLines: 1,
                                    overflow: TextOverflow.ellipsis,
                                    ' '+userdata!['display_name'], style: TextStyle(color: cons.green, fontSize: 35, fontWeight: FontWeight.w900)),
                                ],
                              ),
                            ),
                            Container(
                              ...
                              child: Row(
                                children: [
                                  Text('Your ', style: TextStyle(color: singleton.dark_theme ? Colors.black : Colors.white, fontSize: 35, fontWeight: FontWeight.w900)),
                                  Text('Weekly', style: TextStyle(color: cons.green, fontSize: 35, decoration: TextDecoration.underline, fontWeight: FontWeight.w900)),
                                ],
                              ),
                            ),
                            Container(
                              width: size.width * 0.80,
                              child: Text('Stats', style: TextStyle(color: singleton.dark_theme ? Colors.black : Colors.white, fontSize: 35, fontWeight: FontWeight.w900)),
                            ),
                          ],
                        ),
                      ),
